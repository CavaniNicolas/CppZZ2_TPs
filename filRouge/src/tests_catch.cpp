...
// // 	Forme f;
// // 	REQUIRE (f.getWidth() == 0);
// // 	REQUIRE (f.getHeight() == 0);
// // }
...
// 	Cercle c1;
// 	Cercle c2(Point(1, 1), 3, 3);

// 	REQUIRE(c1.toString() == "Cercle: 0 0 2 2");
// 	REQUIRE(c2.toString() == "Cercle: 1 1 3 3");

// 	c2.setRayon(4);
// 	REQUIRE(c2.getRayon() == 4);
// 	REQUIRE(c2.toString() == "Cercle: 1 1 4 4");
// 	REQUIRE(c2.getWidth() == 4);
// 	REQUIRE(c2.getHeight() == 4);
...
// 	REQUIRE(f1->toString() == "Cercle: 0 0 2 2");
// 	REQUIRE(f2->toString() == "Rectangle: 0 0 2 2"); // Warning a la compile :( non-virtual destructor
